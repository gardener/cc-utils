ARG BASE_IMAGE=europe-docker.pkg.dev/gardener-project/releases/cicd/job-image-base:0.105.0
...
FROM ghcr.io/open-component-model/ocm/ocm.software/ocmcli/ocmcli-image:0.19.0 AS ocm-cli
FROM $BASE_IMAGE
