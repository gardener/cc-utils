...
to the image it describes.  Registries that implement the OCI 1.1 referrers
API will expose it via GET /v2/<repo>/referrers/<digest>; others fall back to
a synthetic tag (<algo>-<hash>, e.g. sha256-abc123).
'''
import hashlib
import json
import logging
