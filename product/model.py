...
class Version:
    ...
    semver versions.
    '''
    @deprecated.deprecated(reason='Version is deprecated')
...
class DependencyBase(ModelBase):
    ...
    Not intended to be instantiated.
    '''
    @deprecated.deprecated(reason='DependencyBase is deprecated')
...
class ComponentReference(DependencyBase):
    ...
    @deprecated.deprecated(reason='ComponentReference is deprecated')
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
