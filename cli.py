...
CUSTOM_WIDTH_FORMATTER = functools.partial(argparse.HelpFormatter, max_help_position=40, width=118)
...
def main():
    ...
    parser = argparse.ArgumentParser(formatter_class=CUSTOM_WIDTH_FORMATTER)
...
def add_module(module_name, parser):
    ...
    if hasattr(module, 'main'):
        return
    module_parser = parser.add_parser(module_name, formatter_class=CUSTOM_WIDTH_FORMATTER)
    ...
    for fname, function in inspect.getmembers(module, predicate=inspect.isfunction):
        ...
        function_parser = function_parsers.add_parser(
            ...
            formatter_class=CUSTOM_WIDTH_FORMATTER,
        )
