...
class ConcourseConfig(NamedModelElement):
    ...
    def ingress_host(self):
        cluster_domain = cluster_domain_from_kubernetes_config(self.kubernetes_cluster_config())
    ...
    def concourse_version(self):
        ...
        concourse_url = urllib.parse.urljoin(self.ingress_url(), CONCOURSE_INFO_API_ENDPOINT)
        try:
    ...
    def compatible_api_version(self) -> ConcourseApiVersion:
        ...
        if not (parsed_cc_version := self.concourse_version()):
