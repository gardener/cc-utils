...
latex_documents = [
    (master_doc, 'index.tex', 'Gardener CI/CD Documentation',
     'The Gardener Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'index', 'Gardener CI/CD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'index', 'Gardener CI/CD Documentation',
     author, 'index', 'Gardener CI/CD Documentation',
     'Miscellaneous'),
]
